...
let AdminService = AdminService_1 = class AdminService {
    ...
    async getBookings(query) {
        ...
        const formattedBookings = bookings.map((booking) => {
            ...
            return {
                ...
                startTime: booking.scheduledStartTime.toISOString().substring(11, 16),
                endTime: booking.scheduledEndTime.toISOString().substring(11, 16),
    ...
    async getPendingVerificationPayments(query) {
        ...
        const formattedPayments = payments.map((payment) => ({
            ...
            screenshotUrl: payment.gatewayResponse?.screenshotUrl,
            screenshotUploadedAt: payment.gatewayResponse?.screenshotUploadedAt,
            ...
            booking: {
                ...
                scheduledStartTime: payment.booking.scheduledStartTime.toISOString().substring(11, 16),
                scheduledEndTime: payment.booking.scheduledEndTime.toISOString().substring(11, 16),
