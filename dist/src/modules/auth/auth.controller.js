...
let AuthController = class AuthController {
    ...
    async resetPassword(body) {
        if (body.email && body.otp) {
            ...
            throw new common_1.BadRequestException('Provide either (email + otp) or token');
        }
        return { success: true, message: 'Password has been reset successfully' };
    }
    async devGetResetToken(email) {
        if (process.env.NODE_ENV === 'production') {
...
__decorate([
    ...
    (0, rate_limit_decorator_1.RateLimit)({ ttl: 60, limit: 50 }),
    (0, swagger_1.ApiOperation)({
        summary: 'User login',
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_1.UseGuards)(rate_limit_guard_1.RateLimitGuard),
    (0, rate_limit_decorator_1.RateLimit)({ ttl: 60, limit: 30 }),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Reset password using OTP or token' }),
...
__decorate([
    (0, common_1.Post)('dev/get-reset-token'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: '[DEV] Get reset token without email' }),
    __param(0, (0, common_1.Body)('email')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "devGetResetToken", null);
__decorate([
