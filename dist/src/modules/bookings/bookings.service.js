    ...
    async cancelBooking(bookingId, userId, reason) {
      ...
      `;
            ...
            if (refundCalculation.refundAmount > 0 &&
                ...
                await this.platformWalletService.debit(refundCalculation.refundAmount, 'BOOKING_REFUND', bookingId, `Refund for cancelled booking ${bookingId} (${refundCalculation.refundPercentage}%)`, bookingId);
